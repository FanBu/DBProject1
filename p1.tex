...
\begin{document}
	...
	And the similarity between $A$ and $B$ is defined as $c_{common} / c_A$. Hence we know that the similarity between $A$ an $B$ is not necessarily equal to the similarity between $B$ and $A$.
	\subsubsection{SQL Script}
	\begin{spverbatim}
